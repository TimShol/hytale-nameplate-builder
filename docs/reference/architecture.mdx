...
1. Check per-viewer Enable Nameplates toggle - skip entirely if disabled for this viewer
2. Resolve segment keys from the component (skip `_`-prefixed and admin-disabled keys)
