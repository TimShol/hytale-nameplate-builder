...
* **Nameplate offset** — Configurable vertical offset for NPCs using invisible anchor entities with velocity prediction (player nameplates always use vanilla client-side rendering)
